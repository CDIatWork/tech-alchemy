...
// Uebung 3: Qualifier fuer die In-Memory-Implementierung des TaskRepository
...
/**
 * Qualifier zur Auswahl des In-Memory-Repositorys.
 * Verwendung: @Inject @InMemory TaskRepository repository;
 */
@Qualifier
@Retention(RUNTIME)
